var cartIcons = document.querySelectorAll('.buy-now');
cartIcons.forEach(function (icon) {
    icon.addEventListener('click', function (event) {
        ...
        var productContainer = icon.closest('.food');
...
cartIcons.forEach(function (icon) {
    icon.addEventListener('click', function (event) {
        ...
        var productContainer = icon.closest('.food');
        var productName = productContainer.querySelector('.des span').innerText;
        var productPrice = parseFloat(productContainer.querySelector('.price p').innerText.replace('đ', '').replace('.', ''));
